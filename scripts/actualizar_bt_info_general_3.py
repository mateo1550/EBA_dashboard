      ...
      'parameters': {
        ...
        'prompt': {
          'messages': [
            {
              'role': 'system',
              'content': 'Eres un asistente que corrige transcripciones de facturas en formato JSON. Se te proporcionará la transcripción original y las correcciones del usuario. Devuelve ÚNICAMENTE el JSON corregido, sin bloques de código ni texto adicional. Solo el array de productos en JSON.'
            },
            {
              'role': 'user',
