    ...
    <div className="bg-card rounded-2xl shadow-sm hover:shadow-md transition-shadow duration-300 p-6 w-full h-full">
      <div className="grid grid-cols-1 min-[900px]:grid-cols-[minmax(0,1fr)_minmax(0,1.15fr)] gap-5">
        <div className="flex min-w-0 flex-col gap-4">
          ...
          <div className="bg-primary/10 text-primary rounded-xl px-5 py-4">
            <span className="block text-sm font-body font-medium">Pagos Totales</span>
            <span className="block text-5xl leading-none mt-2 font-display font-bold">{totalRegistrados}</span>
          </div>

          {pagosWhatsapp !== undefined && (
            <div className="bg-[#25D366]/10 text-[#25D366] rounded-xl px-5 py-4">
              <span className="block text-sm font-body font-medium">Reportados por WhatsApp</span>
              <span className="block text-4xl leading-none mt-2 font-display font-bold">{pagosWhatsapp}</span>
            </div>
          )}
        </div>
